      ...
      <section className="w-full flex justify-center items-center h-screen">
        <div className="min-w-[320px] max-w-full md:min-w-96 shadow-2xl dark:bg-zinc-800 bg-white rounded-lg p-6">
          ...
          >
            ...
            <div className="relative text-center text-sm after:absolute after:inset-0 after:top-1/2 after:z-0 after:flex after:items-center after:border-zinc-800 after:border-t after:border-border">
              <span className="relative z-10 dark:bg-zinc-800 bg-white px-2 text-muted-foreground">
                Or continue with
              </span>
            </div>

            <span className="text-sm my-2 opacity-80">
            ...
            <div className="text-center w-full mt-2">
              <span className="text-sm opacity-90">Don't have an account?</span>
              <Link
                href="/register"
                className="text-sm pl-2 text-primary hover:underline"
              >
                Register
              </Link>
            </div>
